  ...
  if (!post) {
    return (
      <div className="w-full bg-white px-4 py-20 text-center space-y-4">
        <h2 className="text-2xl font-extrabold text-content-strong">Article Not Found</h2>
        <p className="text-xs text-content-muted">The news article you are looking for does not exist or has been removed.</p>
    ...
    <div className="w-full bg-white px-4 md:px-8 py-10">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-1.5 text-xs text-content-muted mb-6 font-medium">
          ...
          <ChevronRight size={12} />
          <span className="text-content-strong font-semibold line-clamp-1">{post.title}</span>
        </div>
